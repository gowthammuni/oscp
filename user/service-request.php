      ...
      <?php $query=mysqli_query($con,"select * from tblcategory");
              ...
              <option value="<?php echo $row['VehicleCat'];?>"><?php echo $row['VehicleCat'];?></option>
                  <?php } ?>  
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label" for="example-email">Car Name</label>
                                                        <div class="col-10">
                                                            <input type="text" id="carname" name="carname" class="form-control" placeholder="Car Name" required="true">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label">Car Model</label>
                                                        <div class="col-10">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label">Car Brand</label>
                                                        <div class="col-10">
                                                            <input type="text" class="form-control" placeholder="Brand" name="vehiclebrand" id="vehiclebrand" required="true">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label">Car Registration Number</label>
                                                        <div class="col-10">
